...
# Example usage:
csv_file = 'results/testsub-d0/delay.csv'
x0_values, y0_values = read_values_from_csv(csv_file)

# Example usage:
csv_file = 'results/testzmq-gse-sub-d1-new/delay.csv'

x1_values, y1_values = read_values_from_csv(csv_file)


# Example usage:
csv_file = 'results/testzmq-gse-sub-d2-new/delay.csv'
...
#Example usage:
csv_file = 'results/testsub-d10/delay.csv'
